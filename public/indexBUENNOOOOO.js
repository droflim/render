...
var id; // Cambiado de broadcast_id a id
var localCandidates = [];
...
async function handleNegotiationNeededEvent(peer) {
    try {
        ...
        localStorage.setItem('broadcast_id', id);

        // Construye la URL única para ver el stream
        const viewUrl = `https://irc.chateachat.com:3000/viewer.html?id=${id}&nick=${encodeURIComponent(nick)}`;
